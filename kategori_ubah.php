<div class="bg-white p-6 rounded-lg shadow-sm">
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Ubah Kategori Buku</h1>
    ...
    if(isset($_POST['submit'])) {
        ...
        if($query) {
            echo '<div class="mb-4 p-4 bg-green-100 text-green-700 rounded-lg">Data berhasil diubah!</div>';
        } else {
            echo '<div class="mb-4 p-4 bg-red-100 text-red-700 rounded-lg">Gagal mengubah data!</div>';
        }
    }
    ...
    <form method="post" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
            ...
            <div class="md:col-span-3">
                <input type="text" name="kategori" value="<?php echo $data['kategori']; ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
            </div>
        </div>
